import { PICTURE_EDIT_MESSAGE_TYPE_ENUM } from '@/constants/picture.ts'
...
export default class PictureEditWebSocket {
  ...
  connect() {
    ...
    const PROD_BASE_URL = "ws://picture.yan-yu.icu";
  ...
  sendSaveMessage() {
    this.sendMessage({
      type: PICTURE_EDIT_MESSAGE_TYPE_ENUM.SAVE_SUCCESS,
    });
  }
