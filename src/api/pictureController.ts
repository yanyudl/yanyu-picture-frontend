...
/** listPictureVOPortByPage POST /api/picture/list/page/port */
export async function listPictureVoPortByPageUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>('/api/picture/list/page/port', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
